...
- [x] ViewForge auditable mask closing/component/hole cleanup and disclosed static surface-finish derivative
...
- [ ] Resolve existing external-link CI failures separately from registry integrity checks.
